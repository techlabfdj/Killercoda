...
if docker images | grep -q "ghcr.io/techlabfdj/java-mem-block-reserver"; then
  echo "The Docker image ghcr.io/techlabfdj/java-mem-block-reserver exists locally."
else
  echo "The Docker image ghcr.io/techlabfdj/java-mem-block-reserver does not exist locally."
